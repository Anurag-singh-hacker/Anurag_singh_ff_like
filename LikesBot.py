...
# Bot Configuration
TOKEN = "8534778362:AAFRBJs6IEtOtsuoFBqQnbAfPVAiQcKC8ck"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [
            InlineKeyboardButton(f"{EMOJI['handshake']} SUBSCRIBE", url="https://youtube.com/@akhackerteam?si=ShXPRr3FmcOuzVZq"),
            InlineKeyboardButton(f"{EMOJI['handshake']} JOIN CHANNEL", url="https://t.me/+uWD5M5dAUnkxNTZl")
        ]
    ]
